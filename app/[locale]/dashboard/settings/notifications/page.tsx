    ...
    <DashboardLayout>
      <div className="flex flex-col gap-6 max-w-2xl">
        ...
        <div>
          ...
          <p className="text-slate-500 mt-1">{t("notifications.description")}</p>
        </div>
        ...
        <Card>
          <CardHeader>
            <div className="flex items-center gap-3">
              ...
              <div>
                <CardTitle className="text-lg">{t("notifications.soundAlerts.title")}</CardTitle>
                <CardDescription>{t("notifications.soundAlerts.description")}</CardDescription>
              </div>
            </div>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader>
            <div className="flex items-center gap-3">
              ...
              <div>
                <CardTitle className="text-lg">{t("notifications.toastNotifications.title")}</CardTitle>
                <CardDescription>{t("notifications.toastNotifications.description")}</CardDescription>
              </div>
            </div>
          </CardHeader>
          <CardContent>
        ...
        <div className="bg-slate-50 border border-slate-200 rounded-lg p-4">
          <p className="text-sm text-slate-600">
            <span className="font-medium">{t("notifications.note.title")}: </span>
