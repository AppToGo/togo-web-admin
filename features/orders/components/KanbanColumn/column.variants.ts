  ...
  "flex flex-col rounded-3xl shrink-0 p-4 h-[calc(100vh-200px)] transition-all duration-200",
  {
    variants: {
      status: {
        ...
        PAYMENT_PENDING: "bg-blue-50/30",
        PAID: "bg-purple-50/30",
        IN_PROGRESS: "bg-purple-50/30",
        READY: "bg-orange-50/30",
        ON_THE_WAY: "bg-orange-50/30",
...
export const columnDragOverVariants = cva("", {
  variants: {
    status: {
      ...
      PAYMENT_PENDING: "ring-2 ring-blue-400 ring-offset-2 bg-blue-50/50",
      PAID: "ring-2 ring-purple-400 ring-offset-2 bg-purple-50/50",
      IN_PROGRESS: "ring-2 ring-purple-400 ring-offset-2 bg-purple-50/50",
      READY: "ring-2 ring-orange-400 ring-offset-2 bg-orange-50/50",
      ON_THE_WAY: "ring-2 ring-orange-400 ring-offset-2 bg-orange-50/50",
...
export const columnHeaderVariants = cva("px-4 py-3 rounded-card-lg mb-3", {
  variants: {
    status: {
      ...
      PAYMENT_PENDING: "bg-blue-100",
      PAID: "bg-purple-100",
      IN_PROGRESS: "bg-purple-100",
      READY: "bg-orange-100",
      ON_THE_WAY: "bg-orange-100",
...
export const cardContainerDragOverVariants = cva("", {
  variants: {
    status: {
      ...
      PAYMENT_PENDING: "bg-blue-100/30",
      PAID: "bg-purple-100/30",
      IN_PROGRESS: "bg-purple-100/30",
      READY: "bg-orange-100/30",
      ON_THE_WAY: "bg-orange-100/30",
...
export const counterTextDragOverVariants = cva("text-xs font-medium px-2 py-0.5 rounded-full transition-colors", {
  variants: {
    status: {
      ...
      PAYMENT_PENDING: "bg-blue-100/50 text-blue-600",
      PAID: "bg-purple-100/50 text-purple-600",
      IN_PROGRESS: "bg-purple-100/50 text-purple-600",
      READY: "bg-orange-100/50 text-orange-600",
      ON_THE_WAY: "bg-orange-100/50 text-orange-600",
...
export const emptyStateDragOverVariants = cva("", {
  variants: {
    status: {
      ...
      PAYMENT_PENDING: "border-blue-300 bg-blue-50/50",
      PAID: "border-purple-300 bg-purple-50/50",
      IN_PROGRESS: "border-purple-300 bg-purple-50/50",
      READY: "border-orange-300 bg-orange-50/50",
      ON_THE_WAY: "border-orange-300 bg-orange-50/50",
...
export const emptyStateIconDragOverVariants = cva("", {
  variants: {
    status: {
      ...
      PAYMENT_PENDING: "bg-blue-200",
      PAID: "bg-purple-200",
      IN_PROGRESS: "bg-purple-200",
      READY: "bg-orange-200",
      ON_THE_WAY: "bg-orange-200",
